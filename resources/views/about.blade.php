      ...
      <div class="row justify-content-between">
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="0">
          <figure class="img-wrap-2">
            <img src="{{asset('asset/images/teacher-min.jpg')}}" alt="Image" class="img-fluid">
      ...
      <div class="row">
        <div class="col-12 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="0">
          <div class="staff text-center">
            <div class="mb-4"><img src="{{asset('asset/images/staff_1.jpg')}}" alt="Image" class="img-fluid"></div>
        ...
        <div class="col-12 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="100">
          <div class="staff text-center">
            <div class="mb-4"><img src="{{asset('asset/images/staff_2.jpg')}}" alt="Image" class="img-fluid"></div>
            <div class="staff-body">
        ...
        <div class="col-12 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="200">
          <div class="staff text-center">
            <div class="mb-4"><img src="{{asset('asset/images/staff_3.jpg')}}" alt="Image" class="img-fluid"></div>
            <div class="staff-body">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-5 mr-auto mb-5 mb-lg-0"  data-aos="fade-up" data-aos-delay="0">
          <img src="{{asset('asset/images/img-school-5-min.jpg')}}" alt="image" class="img-fluid">
        </div>
